...
executive-narrative.md — Recommended starting point. Explains the problem, the governing thesis, and how the repository is organized.
architecture/ — The five ADRs and architecture diagram. This is the design itself.
validation-strategy.md — The strongest single indicator of how the design establishes correctness before production.
evidence/ — Review the executable durability artifact if you want to verify the central engineering claim rather than simply read about it.
